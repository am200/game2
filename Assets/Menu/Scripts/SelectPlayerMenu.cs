...
public class SelectPlayerMenu : AbstractMenu
{
		...
		protected override void DrawMenu ()
		{
				...
				if (GUI.Button (new Rect (leftPos, topPos, ResourceManager.ButtonWidth, ResourceManager.ButtonHeight), ButtonManager.SELECT)) {
						PlayClick ();
						SelectPlayer ();
				}
				...
				if (avatarIndex >= 0) {
						...
						if (GUI.Button (new Rect (buttonLeft, buttonTop, ResourceManager.ButtonHeight, ResourceManager.ButtonHeight), ButtonManager.ARROW_LEFT)) {
								PlayClick ();
								avatarIndex -= 1;
								if (avatarIndex < 0)
						...
						if (GUI.Button (new Rect (buttonLeft, buttonTop, ResourceManager.ButtonHeight, ResourceManager.ButtonHeight), ButtonManager.ARROW_RIGHT)) {
								PlayClick ();
